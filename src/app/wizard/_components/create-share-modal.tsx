        ...
        >
          ...
          <div className="flex items-stretch gap-[var(--space-2)]">
            ...
            <button
              type="button"
              onClick={handleCopy}
              className="rounded-[var(--radius-md)] border border-[var(--color-border)] px-[var(--space-4)] py-[var(--space-2)] text-[var(--text-base)] font-medium text-[var(--color-ink)] transition-transform duration-[var(--duration-fast)] hover:-translate-y-px"
            >
        ...
        >
          ...
          <label className="flex flex-col gap-[var(--space-2)]">
            ...
            <input
              ...
              className="w-full rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] px-[var(--space-4)] py-[var(--space-3)] text-[var(--text-base)] text-[var(--color-ink)] placeholder:text-[var(--color-ink-muted)] focus:border-[var(--color-accent)] focus:outline-none focus:ring-2 focus:ring-[color-mix(in_oklch,var(--color-accent)_30%,transparent)] disabled:opacity-60"
            />
          ...
          <footer className="flex items-center justify-end gap-[var(--space-3)]">
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className="rounded-[var(--radius-md)] px-[var(--space-4)] py-[var(--space-2)] text-[var(--text-base)] text-[var(--color-ink-muted)] underline-offset-4 hover:text-[var(--color-ink)] hover:underline disabled:opacity-60"
            >
              Cancel
            </button>
            <button
